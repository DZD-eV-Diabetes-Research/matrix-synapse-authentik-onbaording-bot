...
- **Release pipeline:** `.github/workflows/release.yml` builds and publishes the image to GHCR on a
  `v*` tag (semver tags, OCI labels, build provenance + SBOM). This `CHANGELOG.md`.
